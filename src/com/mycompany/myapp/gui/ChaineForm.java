...
import static com.mycompany.myapp.gui.ListTasksForm.listSearch;
import static com.mycompany.myapp.gui.ListTasksForm.roundImage;
...
public class ChaineForm extends Form{
    ...
    public ChaineForm(Form previous) {
        setTitle("List tasks");
        ...
        listPublication=ServiceTask.getInstance().getChaine(listLogin.get(0).getUsername());
...
Image imgLineC3 = getImageFromTheme(ligne).scaledWidth(Math.round(Display.getInstance().getDisplayWidth() / 1));
        ...
        f2.getToolbar().addCommandToSideMenu("Acceuil", iconHome, (e) -> new ListTasksForm(current).show());
        f2.getToolbar().addCommandToSideMenu("Chaine", iconChaine, (e) -> Log.p("Clicked"));
        ...
        getToolbar().addCommandToSideMenu("Acceuil", iconHome, (e) -> new ListTasksForm(current).show());
        getToolbar().addCommandToSideMenu("Chaine", iconChaine, (e) -> Log.p("Clicked"));
